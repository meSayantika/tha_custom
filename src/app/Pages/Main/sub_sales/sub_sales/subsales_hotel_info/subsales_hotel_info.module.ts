...
import { Subsales_hotel_infoComponent } from './subsales_hotel_info.component';
...
const routes: Routes=[
  {
    path:'',
    component:Subsales_hotel_infoComponent
  }
]
@NgModule({
  imports: [
  ...
  declarations: [Subsales_hotel_infoComponent]
})
export class Subsales_hotel_infoModule { }
