...
export class LoginComponent implements OnInit {
  ...
  constructor(private formBuilder:FormBuilder,private router:Router,private dataServe:DataService,private msg: MessageService) { }
      ...
      if (this.getLoginData.suc > 0)
        {
          ...
          this.router.navigate(['main/subsales/dashboard']).catch(data=>{
