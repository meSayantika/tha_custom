...
@Component({
  selector: 'app-subsales_add_hotel',
  templateUrl: './subsales_add_hotel.component.html',
  styleUrls: ['./subsales_add_hotel.component.css']
})
export class Subsales_add_hotelComponent implements OnInit {
  ...
  regSubmit(){
    ...
    this.dataServe.global_service(1,'/registration',dt).subscribe(data=>{
      ...
      if(this.regData.suc>0)
      {
         ...
         this.regForm.reset()
         this.router.navigate(['main/subsales/dashboard']).catch((data: any) => {
