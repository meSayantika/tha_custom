...
@Component({
  selector: 'app-flip-book-hotel',
  templateUrl: './flip-book-hotel.component.html',
  styleUrls: ['./flip-book-hotel.component.css']
})
export class FlipBookHotelComponent implements OnInit {
  displayedColumns: string[] = ['id', 'restaurant_name','check'];
  ...
  // localStorage.setItem('Restaurant_email',this.logData.msg.email_id);
    window.open(environment.routeUrl+'main/admin/flip_book_dash/'+btoa(v.id))
