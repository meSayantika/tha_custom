...
@Component({
  selector: 'app-dep-mng-dashboard',
  templateUrl: './dep-mng-dashboard.component.html',
  styleUrls: ['./dep-mng-dashboard.component.css']
})
export class DepMngDashboardComponent implements OnInit {
  ...
  dep_name:any
  ngOnInit() {
    localStorage.setItem('mngFlag','E')
