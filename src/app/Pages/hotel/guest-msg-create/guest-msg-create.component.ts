...
@Component({
  selector: 'app-guest-msg-create',
  templateUrl: './guest-msg-create.component.html',
  styleUrls: ['./guest-msg-create.component.css']
})
export class GuestMsgCreateComponent implements OnInit {
  ...
  go_prev_page(){
    this.router.navigate(['hotel/hotel_guest_msg',btoa(this.hotel_id)]).catch(data=>{
