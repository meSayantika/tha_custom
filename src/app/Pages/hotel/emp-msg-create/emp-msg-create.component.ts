...
@Component({
  selector: 'app-emp-msg-create',
  templateUrl: './emp-msg-create.component.html',
  styleUrls: ['./emp-msg-create.component.css']
})
export class EmpMsgCreateComponent implements OnInit {
  ...
  go_prev_page(){
    this.router.navigate(['hotel/hotel_emp_msg',btoa(this.hotel_id)]).catch(data=>{
  ...
  gen_body(){
    ...
    this.subjectLine=`Welcome ${this.mngForm.controls.mng_name.value}`
    this.email_body=`Hello ${this.mngForm.controls.mng_name.value},
